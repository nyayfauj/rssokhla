...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-[#050606] text-zinc-100 overflow-x-hidden selection:bg-red-500/30">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 pb-32">
        <div className="container mx-auto px-4 relative z-10 text-center space-y-12">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-red-600/10 border border-red-600/20 text-[10px] font-black uppercase tracking-[0.4em] text-red-500 animate-fade-in shadow-[0_0_20px_rgba(239,68,68,0.1)]">
            Institutional Protocol: NYAYFAUJ
          </div>
          ...
          <div className="space-y-4">
            <h1 className="text-7xl md:text-9xl font-black tracking-tighter uppercase italic text-gradient-red animate-slide-up leading-[0.9]">
              AUTONOMOUS<br/><span className="text-white/10 outline-text">VIGILANCE</span>
            </h1>
            <p className="text-zinc-600 text-[10px] md:text-xs font-black uppercase tracking-[0.5em] animate-fade-in delay-300">
              Periphery Intelligence Infrastructure // v4.0.2
            </p>
          </div>
          
          <div className="max-w-xl mx-auto space-y-6">
            <p className="text-zinc-400 text-sm md:text-base font-medium leading-relaxed animate-fade-in delay-500">
              NyayFauj is a decentralized, real-time intelligence network monitoring the Okhla periphery. We leverage advanced machine learning and community-driven telemetry to expose threats that traditional systems ignore.
            </p>
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-6 animate-fade-in delay-700">
            ...
            <Link href="#manifesto" className="px-10 py-4 bg-zinc-900/50 backdrop-blur-md border border-zinc-800/60 hover:border-zinc-500 text-zinc-400 text-[10px] font-black uppercase tracking-[0.3em] rounded-xl transition-all group">
              Read Manifesto <span className="inline-block transition-transform group-hover:translate-y-1">↓</span>
            </Link>
          </div>
        </div>
      </section>
      ...
      {/* Manifesto Section */}
      <section id="manifesto" className="container mx-auto px-4 py-32 space-y-40">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          <div className="w-px h-24 bg-gradient-to-b from-red-600 to-transparent mx-auto"></div>
          <h2 className="text-5xl md:text-7xl font-black uppercase italic tracking-tighter text-white">The Manifesto.</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-left">
            <div className="space-y-6">
              <p className="text-xl font-bold text-red-500 italic">"The state is not the only source of authority; the community is the source of truth."</p>
              <p className="text-zinc-500 text-sm leading-relaxed">
                We believe that safety is an autonomous right. NyayFauj was built as a counter-intelligence framework to protect marginalized geographies from radicalization and institutional neglect.
              </p>
            </div>
            <div className="space-y-6 pt-6 md:pt-0">
              <p className="text-zinc-400 text-sm leading-relaxed">
                By decentralized data collection and AI-driven verification, we map the invisible networks of hostility that threaten our peace. Our code is our shield, our data is our weapon.
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-1 px-4 sm:px-0">
          <TacticalCard 
            id="01"
            title="SIGHTING ANALYSIS"
            desc="Automated identification of known field operatives via community telemetry."
          />
          <TacticalCard 
            id="02"
            title="ZONAL HEATMAPS"
            desc="Visualizing threat density across Shaheen Bagh, Jasola, and Jamia sectors."
          />
          <TacticalCard 
            id="03"
            title="AUTONOMOUS ALERTS"
            desc="Real-time push notifications for verified security breaches in the periphery."
          />
        </div>
        ...
        <div className="relative group p-1 bg-gradient-to-b from-zinc-800/40 to-transparent rounded-[3rem]">
          <div className="bg-[#050606] rounded-[2.9rem] p-16 md:p-24 text-center space-y-10">
            ...
            <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter italic">We Are The Watchers.</h2>
            <p className="text-zinc-500 text-sm md:text-lg max-w-3xl mx-auto leading-relaxed">
              NyayFauj is not an app. It is a protocol. It is an immutable layer of vigilance that remains active as long as there is a threat. 
              Join the network, secure your sector.
            </p>
            <div className="pt-6">
              <Link href="/login" className="px-12 py-5 bg-white text-black text-[10px] font-black uppercase tracking-[0.4em] rounded-full hover:bg-red-600 hover:text-white transition-all">
                Access Protocol
              </Link>
            </div>
          </div>
