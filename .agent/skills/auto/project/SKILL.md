---
name: project
description: "Project for rssokhla. 19 gotchas, 98 conventions."
domain: project
triggers:
  - glob: "**/*"
autoGenerated: true
...
Auto-compiled from **126 real patterns** in **rssokhla**. This skill is auto-routed to agents when working on project files.
...
- 📐 **Strengthened types Added** — - - Added error handling db
+ - problem-fix in shared-context.json
- - Fixed null crash in Cancel — 
- 📐 **Strengthened types Added** — - - Patched security issue LUrGen
+ - Added error handling db
- - Added error handling db
+ - Fixed 
- 📐 **Strengthened types Added** — - - Patched security issue TaLuUNvvfbI
+ - Added error handling db
- - problem-fix in IdVerification
- 📐 **Strengthened types Patched** — - - problem-fix in IdVerification.tsx
...
---
*Auto-generated by BrainSync 🧠 | 126 patterns | 2026-04-29*
